...
public class DashboardServiceImpl implements DashboardService {
	...
	public DashboardResponse getDashboardSummary() {
		return new DashboardResponse(new DashboardResponse.UserMetrics(0, 0, 0, 0),
				new DashboardResponse.OrganizationMetrics(0, 0, 0), new DashboardResponse.RoleMetrics(0),
